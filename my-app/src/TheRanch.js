...
function TheRanch ( {bank, setBank, setSpeed, speed, user}) {
    ...
    return (
        <div id="the-ranch">
            <img src={ranch}></img>
            <h1>Debt to Bank: {remainder > 0 ? new Intl.NumberFormat('us-US', { style: 'currency', currency: 'USD' }).format(remainder) : alert(`${user}! You saved Codee Ranch and restored the family name!!!!! You green thumb, you!`)}</h1>

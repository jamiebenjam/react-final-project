...
function TheRanch ( {bank, setBank, setSpeed}) {
    ...
    const goal = 30050
    const remainder = goal.toFixed(2) - bank.toFixed(2)


    return (
        <div>
            <p>Goal: ${remainder > 0 ? remainder : alert(`You saved Codee Ranch and restored the family name!!!!! You green thumb, you!`)}</p>
            <h1>Bank Amount: </h1>
            <p>${bank.toFixed(2)}</p>
